  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8 md:px-8">
      ...
      <div className="mb-6 flex items-center gap-2 text-sm text-white/40">
        ...
        <span>/</span>
        <Link href="/dashboard/admin" className="hover:text-white/70 transition-colors">Conteúdos</Link>
        <span>/</span>
      ...
      <form action={updateContent.bind(null, content.id)} className="flex flex-col gap-5">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <Link href="/dashboard/admin" className="text-sm text-white/40 hover:text-white/70 transition-colors">
            Cancelar
          </Link>
        </div>
      </form>
