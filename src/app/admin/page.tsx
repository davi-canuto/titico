    ...
    <main className="mx-auto max-w-6xl px-4 py-8 md:px-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <Link href="/lobby" className="text-xs text-white/40 hover:text-white/70 transition-colors">
            ← Voltar ao Dashboard
          </Link>
        </div>
      </div>
      ...
      <div className="mb-6 flex gap-6 border-b border-white/5">
        <Link href="/admin?tab=conteudos" className={tabCls("conteudos")}>
          Conteúdos ({contents.length})
        </Link>
        <Link href="/admin?tab=trilhas" className={tabCls("trilhas")}>
          Trilhas ({trails.length})
        </Link>
        <Link href="/admin?tab=analytics" className={tabCls("analytics")}>
          Analytics
        </Link>
        <Link href="/admin?tab=produtos" className={tabCls("produtos")}>
          Produtos ({products.length})
        </Link>
        <Link href="/admin?tab=usuarios" className={tabCls("usuarios")}>
          Usuários
        </Link>
        <Link href="/admin?tab=criadores" className={tabCls("criadores")}>
          Criadores
        </Link>
        <Link href="/admin/pagamentos" className={tabCls("pagamentos")}>
          Pagamentos
        </Link>
